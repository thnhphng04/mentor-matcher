...
STRINGS = {
    "en": {
        ...
        "q3_inherits": "Inherits Q2 weights — focus: {focus}, trait: {trait} (set in the Q2 frame above).",
        ...
        "q4_inherits": "Inherits Q2 weights (focus: {focus}, trait: {trait}) and Q3 weights "
                       "(symptom: {symptom}, mentor_pref: {pref}) — set in the frames above.",
        "run_q3": "▶ Run Q3",
    ...
    "vi": {
        ...
        "q3_inherits": "Kế thừa trọng số Q2 — lĩnh vực: {focus}, tính cách: {trait} (đặt ở khung Q2 phía trên).",
        ...
        "q4_inherits": "Kế thừa trọng số Q2 (lĩnh vực: {focus}, tính cách: {trait}) và Q3 "
                       "(triệu chứng: {symptom}, mentor_pref: {pref}) — đặt ở các khung phía trên.",
        "run_q3": "▶ Chạy Q3",
...
### 2. Run the questions — ❓ Questions tab
Q1, Q2, Q3, Q4 are stacked top-to-bottom, each in its own framed box with its own controls and a **Run** button:
...
### 2. Chạy các câu hỏi — tab ❓ Câu hỏi
Q1, Q2, Q3, Q4 được xếp lần lượt từ trên xuống, mỗi câu trong một khung riêng với điều khiển riêng và một nút **Run**:
